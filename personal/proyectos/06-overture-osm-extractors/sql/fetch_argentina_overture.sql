...
COPY (
  ...
  -- a Chile, Bolivia, Paraguay, Brasil y Uruguay. El filtro real de pais es
  -- addresses[1].country.
...
) TO 'argentina_overture_leads.csv' (HEADER, DELIMITER ',');

SELECT count(*) AS total_exportado FROM read_csv('argentina_overture_leads.csv');
