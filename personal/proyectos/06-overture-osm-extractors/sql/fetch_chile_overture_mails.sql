-- Extraccion de mails de negocios en Chile desde Overture Maps.
-- Gemela de fetch_chile_overture.sql, que saca telefonos.
--
...
-- Peru, Bolivia y Argentina. El filtro real de pais es addresses[1].country.
...
) TO 'chile_overture_mails.csv' (HEADER, DELIMITER ',');
...
FROM read_csv('chile_overture_mails.csv');
